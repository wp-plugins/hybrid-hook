...
function hybrid_hook_settings_page_init() {
	...
	$hybrid_hook->settings_page = add_theme_page( __( 'Hybrid Hook Settings', 'hybrid-hook' ), __( 'Hybrid Hook', 'hybrid-hook' ), 'edit_theme_options', 'hybrid-hook-settings', 'hybrid_hook_settings_page' );
...
function hybrid_hook_settings_page() {
	...
	<div class="wrap">
		...
		<h2><?php _e( 'Hybrid Hook Plugin Settings', 'hybrid-hook' ); ?></h2>
